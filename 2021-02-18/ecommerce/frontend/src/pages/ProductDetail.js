        ...
        <div className="detail">
          ...
          <div className="detail-action">
            <ul>
              ...
              <li>จำนวนที่ต้องการ: <select value={qty} onChange={event => {setQty(event.target.value)}}>
              ...
              <li><button onClick={handleAddToCart} className="checkout primary">เพิ่มลงตะกร้า</button></li>
            </ul>
          </div>
        </div>
      </div>
